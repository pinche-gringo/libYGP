...
class ValueBase_Attribute : public ValueBase {
  public:
    ...
    static GType value_type() { return G_TYPE_STRING; }

    /// Creates the parameter specification for the passed data-type
    GParamSpec* create_param_spec(const ustring& name) const {
        return g_param_spec_string(name.c_str(), 0, 0, get_cstring(), GParamFlags(G_PARAM_READABLE | G_PARAM_WRITABLE));
    }

    /// Sets from another AttributValue
    /// \param data Value to set
    void set(const YGP::AttributValue& data) { g_value_set_string(&gobject_, data.toString().c_str()); }

  protected:
    /// Sets the value as c-string
    /// \param data c-string to set
    /// \remarks never returns 0
    void set_cstring(const char* data) { g_value_set_string(&gobject_, data); }
...
template <> class Value<YGP::AYear> : public ValueBase_Attribute {
  public:
...
template <> class Value<YGP::ADate> : public ValueBase_Attribute {
  public:
    typedef YGP::AttributValue CppType;
...
template <> class Value<YGP::ATime> : public ValueBase_Attribute {
  public:
    typedef YGP::AttributValue CppType;
...
template <> class Value<YGP::ATimestamp> : public ValueBase_Attribute {
  public:
    typedef YGP::AttributValue CppType;

    YGP::ATimestamp get() const { return YGP::ATimestamp(get_cstring()); }
    void set(const YGP::ATimestamp& data) { set_cstring(data.toString().c_str()); }
};

template <> class Value<YGP::ANumeric> : public ValueBase_Attribute {
  public:
    typedef YGP::AttributValue CppType;
