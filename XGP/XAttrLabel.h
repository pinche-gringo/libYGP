...
template <class T> class XAttributeLabel : public Gtk::Label {
  public:
    ...
    XAttributeLabel(const T& attr) : Gtk::Label("", false), attr_(attr) { update(); }
    /// Constructor; pass the attribute to manage. It is aligned according to
    /// the values.
    XAttributeLabel(const T& attr, gfloat x, gfloat y) : Gtk::Label("", false), attr_(attr) {
        set_xalign(x);
        set_yalign(y);
        update();
    }
...
template <class T> class XAttributeLabel2 : public Gtk::Label {
  public:
    /// Constructor; pass the attribute to manage. It is aligned according to
    /// the values.
    XAttributeLabel2(const T& attr) : Gtk::Label("", false), attr_(attr) { update(); }
    /// Constructor; pass the attribute to manage. It is aligned according to
    /// the values.
    XAttributeLabel2(const T& attr, gfloat x, gfloat y) : Gtk::Label("", false), attr_(attr) {
        set_xalign(x);
        set_yalign(y);
        update();
    }
