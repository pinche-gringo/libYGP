...
class Process {
  public:
    ...
    static pid_t execAsync(const char* file, const char* const arguments[]) { return start(file, arguments, NO_WAIT); }
    ...
    ///    - Return 0 if OK and !0 if an error occured
    ///    - In case of an error the output should contain a describing message
    static void execute(const char* file, const char* const arguments[]) { start(file, arguments, WAIT); }
    ...
    ///    - Return 0 if OK and !0 if an error occured
    ///    - In case of an error the output should contain a describing message
    static pid_t execIOConnected(const char* file, const char* const arguments[], int* fd,
