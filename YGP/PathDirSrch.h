...
class PathDirectorySearch : public DirectorySearch {
  public:
    ...
    PathDirectorySearch()
        : DirectorySearch(), srch(), path(std::string(), boost::char_separator<char>(Path::SEPARATOR_STR)), i(path.begin()) {}
    ...
    PathDirectorySearch(const std::string& srcPath)
        : DirectorySearch(), srch(), path(srcPath, boost::char_separator<char>(Path::SEPARATOR_STR)), i(path.begin()) {}
